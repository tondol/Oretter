...
<form action="<?= escape($this->get_url('post/tweet')) ?>" method="post">
...
?>
<ul>
	<li><a href="<?= escape($this->get_url(null, $current_params)) ?>" accesskey="0">[0]タイムラインを更新</a></li>
	<?php if ($prev): ?>
		<li><a href="<?= escape($this->get_url(null, $prev_params)) ?>" accesskey="4">[4]前を見る</a></li>
	<?php endif; ?>
	<?php if ($next): ?>
		<li><a href="<?= escape($this->get_url(null, $next_params)) ?>" accesskey="6">[6]次を見る</a></li>
	<?php endif; ?>
