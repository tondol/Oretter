...
<p>Twitterのサイトに自動的に移動するので、（Twitterにまだログインしていない場合は）あなたのアカウントでTwitterにログインする。<br />
続いて、Oretterがあなたのアカウントにアクセスすることを許可するかどうか聞かれるので、これを許可する。<br />
すると、Oretterのトップページに自動的に移動する。</p>
...
Oretterにログインした状態でナビゲーションから「簡易ログインを設定」を開いてみる。<br />
...
Oretterにログインした状態でナビゲーションから「[#]実況ビュー」を開いてみる。<br />
『検索ワード』の入力欄にハッシュタグを入力して検索ボタンを押すと、そのハッシュタグを含むつぶやきが表示される。<br />
実況ビューでは『[7]つぶやきを投稿』の入力欄に自動でハッシュタグが入力されるため、快適にtsudaることができる。</p>

<h2>アクセスキーとは？</h2>
<p>ボタンを押すと対応する機能にアクセスできる機能のこと。<br />
例えば『[1]トップページ』というリンクがあったら、「1」のボタンを押して移動することができる。<br />
Oretterの主要な機能にはすべてアクセスキーが設定されているので、うまく活用してね。</p>
